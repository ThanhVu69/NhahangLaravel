...
<head>
  ...
  <title>Hóa đơn online ngày</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <i class= "fa  fa-calendar-minus-o"></i>
              <a href="hoadonbanonline">Trở về hóa đơn online >></a><br><br>
              <h3 class="box-title">Hóa đơn online theo ngày </h3>
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <td>{{$item->Khachhang->ten}}</a></td>
				 <td>{{$item->ngay}}</td>
                 <td>{{$item->tongtien}}.000VNĐ</td>
			    
                 <td><i class="fa fa-pencil fa-fw"></i><a href="cthdbanonline/{{$item->id}}" >Xem thêm</a></td>
			     </tr>
			      @endforeach
