  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <h5><a href="{{url('phieuxuat')}}">Quay lại</a></h5>
      </section>
      <!-- Main content -->
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <div class="row invoice-info">
                  ...
                  <!-- /.col -->
                  <div class="col-sm-4 invoice-col">
                    <strong>Mã Phiếu Xuất: </strong> {{$phieuxuat->ma}}{{$phieuxuat->id}}<br>
                    <strong>Ngày xuất: </strong>{{$phieuxuat->Ngay}}<br>
                    <strong>Cửa hàng xuất đến: </strong>{{$phieuxuat->cuahang->TenCH}}<br>
                    <strong>Người xuất: </strong>{{$phieuxuat->User->name}}
                  </div>
                  <!-- /.col -->
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    @foreach($ctpxuat as $ctpxuat)
                    <tr style=" text-align: center">
                      <td>{{$ctpxuat->hanghoa->Ten}}</td>
                      <td>{{$ctpxuat->SoLuong}}</td>
                      <td>{{$ctpxuat->hanghoa-> DVTinh}}</td>
                    </tr>
                    @endforeach
                  </tbody>
                  </tfoot>
