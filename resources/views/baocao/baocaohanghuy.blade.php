  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h4>Báo cáo hàng hủy</h4>
        <i class="fa  fa-file-text-o"></i>
        @if(session('cart'))
        <a href="giobchanghuy">Xem hàng hủy</a></li><br>
        @else
        Xem hàng hủy
        @endif
      </section>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="  text-align: center"><a href="{{ url('thembaocaohanghuy/'.$product->id) }}"
