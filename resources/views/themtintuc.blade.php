  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <a href="themtintuc">Thêm tin tức</a></li><br>
            ...
            @endif
              ...
              <div class="box-body">
                <div class="table table-bordered table-hover">
                  <form action="themtintuc" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row" style="margin-bottom:40px">
                      <div class="col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <input required id="hinh" type="file" name="hinh" class="form-control hidden"
                        ...
                        <a href="tintuc" class="btn btn-danger">Hủy bỏ</a>
                      </div>
                    </div>
                  </form>
