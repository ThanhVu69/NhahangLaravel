...
@include('trangquanly.thanhmenu')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      @if(session('cart'))
      <a href="giohangkhonhap">Xem</a></li><br>
      @else
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách hàng khô</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            @if(session('thongbao'))
            ...
            @endif
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                 ...
                 <td style="  text-align: center"><a href="{{ url('themnhaphangkho/'.$product->id) }}" class="btn btn-warning btn-block text-center" >{{$product->Ten}}</a></td>
