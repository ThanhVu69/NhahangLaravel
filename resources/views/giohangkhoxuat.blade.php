...
@include('trangquanly.thanhmenu')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="xuathangkho">Xuất thêm hàng khô</a></li><br>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
              <form action="giohangkhoxuat" method="post">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                
                <div class="form-group">
                	<label>Nơi xuất</label><br>
                  <label><a href="coso">Xem chi tiết nơi xuất</a></label>
              ...
              <input type="submit" name="submit" value="Xuất hàng" class="btn btn-primary" />
             </div >
             </form >
             @endif
            </div>
