...
<!-- /.box-header -->
        ...
        @endif               
			  ...
			  <!-- <div class="col-lg-12 text-center"><a href="thanhtoan" type="submit"  value="Tiến hành thanh toán" class="btn btn-primary" >Tiến hành thanh toán</a> -->
      ...
      <label class="ra">Nam
        <input type="radio" @if(Auth::user()->gioitinh =='Nam')checked @endif name="gioitinh" value="Nam">
        <span class="checkmark"></span>
      </label>
      <label class="ra">Nữ
        <input type="radio" @if(Auth::user()->gioitinh =='Nữ')checked @endif name="gioitinh" value="Nữ">
        <span class="checkmark"></span>
      </label>
      <div class="form-group">
        <label>SĐT</label>
