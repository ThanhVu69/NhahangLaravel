                    ...
                    <div class="row" style="margin-bottom:40px">
                      <div class="col-xs-8">
                        <div class="form-group">
                          ...
                          <input required id="image" type="file" name="image" class="form-control hidden"
                            onchange="changeImg(this)">
                          <img id="avatar" class="thumbnail" width="300px"
                            src="{{asset('online/images/'.$monan->image)}}">
                        </div>
                        <div class="form-group">
                          <label>Mã món ăn</label>
                          <input required type="text" name="ma" class="form-control" value="{{$monan->ma}}">
                        </div>
                        <div class="form-group">
                          <label>Tên món ăn</label>
                          <input required type="text" name="Ten" class="form-control" value="{{$monan->Ten}}">
                        </div>
                        <div class="form-group">
                          <label>Đơn giá</label>
                          <input required type="number" name="dongia" class="form-control" value="{{$monan->dongia}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input required type="text" name="DVTinh" class="form-control" value="{{$monan->DVTinh}}">
                        </div>
                        <div class="form-group">
                          <label>Mô tả</label>
                          <input required type="text" name="mota" class="form-control" value="{{$monan->mota}}">
                        </div>
                        <div class="form-group">
                          <label>Sản phẩm đóng gói</label>
                          <select required name="spdg" class="form-control">
                            <option value="1" @if($monan->spdg==1) selected @endif>Có</option>
                            <option value="0" @if($monan->spdg==0) selected @endif>Không</option>
                          </select>
                        </div>
                        <div class="form-group">
                          <label>Sản phẩm tiêu biểu</label><br>
                          <label class="ra">Có
                            <input type="radio" @if($monan->top==1)checked @endif name="top" value="1">
                            <span class="checkmark"></span>
                          </label>
                          <label class="ra">Không
                            <input type="radio" @if($monan->top==0)checked @endif name="top" value="0">
                            <span class="checkmark"></span>
                          </label>
                        </div>
