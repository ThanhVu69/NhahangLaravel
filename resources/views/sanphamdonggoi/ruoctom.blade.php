			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<div class="inner-column">
						...
						<p>Ruốc tôm Gia An được làm từ tôm thẻ đang bơi, loại 5-6 con/lạng. Ruốc tôm Gia An thơm ngọt và có hương vị đặc biệt, khác hoàn toàn ruốc tôm thông thường.  </p>
						<p><i>Nguyên vật liệu</i></p>
						<p>Tôm thẻ đang bơi, gia vị.</p>
						<p>Không sử dụng: chất bảo quản, phụ gia, phẩm mầu, hương liệu.</p>
						<p><i>Sản xuất và giao hàng</i></p>
						<p>Ruốc tôm Gia An được sản xuất và giao hàng tận nơi khi có đơn hàng. Sản phẩm được sản xuất và giao hàng trong cùng 1 ngày.</p>
						<p><i>Bảo quản</i></p>
						<p>Nhiệt độ thường. Đậy kín nắp. Để nơi mát mẻ khô ráo, tránh ánh nắng mặt trời. Mùa xuân (hoặc khi độ ẩm cao) nên sao lại ruốc tôm sau 4 ngày.</p>
						<p><i>Hạn sử dụng</i></p>
						<p>8 ngày từ ngày sản xuất</p>
						<p><i>Hướng dẫn sử dụng</i></p>
						<p>Ăn cùng bánh cuốn, cơm, xôi, cháo, bánh mỳ.</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<div class="col-md-8">
							<img src="online/images/Ruoc tom.jpg" alt="" class="img-fluid" />
							<img src="online/images/RUOCTOMPAGE1.png" alt="" class="img-fluid" />
							<img src="online/images/RUOCTOMPAGE2.png" alt="" class="img-fluid" />
				        </div>
					</div>
				</div>
			</div>
