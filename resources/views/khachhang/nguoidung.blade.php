...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <img src="home/img/{{Auth::user()->image}}" width= "50px" height= "50px" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="hodonban"><i class="fa fa-circle-o"></i> Hóa đơn bán</a></li>
          </ul>
        </li>
        <li class="active treeview menu-open">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="themuser">Thêm nhân viên bán hàng</a></li><br>
      @endif
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                 ...
                 <td>{{$us->SDT}}</td>
                 @if($xem_ac[0]->quyen==1)
                 <td><i class="fa fa-trash-o fa-fw" ></i><a href="xoauser/{{$us->id}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger">Delete</a></td>
                 <td><i class="fa fa-pencil fa-fw"></i><a href="suauser/{{$us->id}}" onclick="return confirm('Bạn có chắc chắn muốn sửa?')">Edit</a></td>
                 @endif
