        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Danh sách phiếu xuất</h3><br>
              <div class="col-xs-4">
              <form action="phieuxuatngay" method="get">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                <thead>
                <tr role="row">
                <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Mã PX: activate to sort column descending" style="width: 80.2px;" aria-sort="ascending">Mã PX</th>  
                ...
                <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Người xuất: activate to sort column descending" style="width: 80.2px;" aria-sort="ascending">Người xuất</th>            
                ...
                <tbody>
                 @foreach($phieuxuat as $product)
                 <tr">
				 <td >{{$product->ma}}{{$product->id}}</td>
                 <td >{{$product->cuahang->TenCH}}</td>
                 <td>{{$product->Ngay}}</td> 
                 <td>{{$product->User->name}}</td>             
                 <td><i class="fa fa-pencil fa-fw"></i><a href="ctpxuat/{{$product->id}}" >Xem thêm</a></td>
			      </tr>
			      @endforeach
