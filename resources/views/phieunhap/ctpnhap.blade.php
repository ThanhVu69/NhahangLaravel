                    ...
                    <div class="col-xs-6" align=center>
                        <div class="box box-info" style="min-height:500px">
                            <div class="box-header">
                                <form action="ctpnhap" method="post">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieunhap->id}}" name="id_phieunhap"
                                            id="id_phieunhap" class="form-control" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieunhap->ThanhTien}}" name="ThanhTien"
                    ...
                    <div class="col-xs-6">
                        <div class="box box-danger" style="min-height:500px">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">{{$phieunhap->ma}}{{$phieunhap->id}}</h3><br>
                            </div>
                            <div class="box-body">
                                @if(session('thongbao'))
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style=" text-align: center">
                                            ...
                                            <td><a href="/ctpnhap/xoactpnhap/{{$cthdban->id}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="/suactpnhap" method="post">
                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="ThanhTien" class="form-control"
                                        value="{{$ct->phieunhap->ThanhTien}}" />
                                </div>
                                <input type="hidden" name="id_phieunhap" value="{{$ct->id_phieunhap}}" />
