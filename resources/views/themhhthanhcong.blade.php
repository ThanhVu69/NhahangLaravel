  ...
  <div class="content-wrapper">
    ...
    <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Nhập Hàng Thành Công!</h3>
        ...
        <div class="box-body">
        <p>
            Về <a href="trangchu">TRANG CHỦ>></a><br><br><br>
            <a href="nhaphangan">NHẬP TIẾP HÀNG ĂN>></a> <br><br>
            <a href="nhaphangkho">NHẬP TIẾP HÀNG KHÔ>></a>
          </p>
        </div>
        <!-- /.box-body -->
