...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <a href="{{url('phieutra')}}" class="btn btn-info"><i class="fa fa-arrow-left"></i> Trở về phiếu trả hàng</a><br><br>
            </section>
            <!-- Main content -->
                    ...
                    <div class="col-xs-6" align=center>
                        <div class="box box-info" style="min-height:500px">
                            <div class="box-header">
                                <form action="ctptra" method="post">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieutra->id}}" name="id_phieutra"
                                            id="id_phieutra" class="form-control" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieutra->ThanhTien}}" name="ThanhTien"
                    ...
                    <div class="col-xs-6">
                        <div class="box box-danger" style="min-height:500px">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">{{$phieutra->ma}}{{$phieutra->id}}</h3><br>
                            </div>
                            <div class="box-body">
                                @if(session('thongbao'))
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style=" text-align: center">
                                            ...
                                            <td><a href="/ctptra/xoactptra/{{$cthdban->id}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="/suactptra" method="post">
                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="ThanhTien" class="form-control"
                                        value="{{$ct->phieutra->ThanhTien}}" />
                                </div>
                                <input type="hidden" name="id_phieutra" value="{{$ct->id_phieutra}}" />
