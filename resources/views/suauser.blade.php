...
<head>
  ...
  <title>Sửa nhân viên bán hàng</title>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Sửa nhân viên bán hàng</h3>
              </div>
              @if(session('thongbao'))
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Tên NV" value="{{$user->name}}"/>
                </div>
                <div class="form-group">
                	<label>Email</label>
                ...
                <div class="form-group">
                	<label>SĐT</label>
                    <input type="text" name="SDT" class="form-control" placeholder="Số điện thoại" value="{{$user->SDT}}"/>
                </div>
                <div class="form-group">
                	<label>Địa chỉ</label>
                    <input type="text" name="DiaChi" class="form-control" placeholder="Địa chỉ" value="{{$user->DiaChi}}" />
                </div>
                <div class="form-group">
                	<label>Quyền</label>
                    <input type="text" name="quyen" class="form-control" placeholder="Quyền (0 or 1)" value="{{$user->quyen}}" />
                </div>

                <input type="submit" name="submit" value="Sửa" class="btn btn-primary">
                        <a href="{{asset('nguoidung')}}" class="btn btn-danger">Hủy bỏ</a>
            </form>
