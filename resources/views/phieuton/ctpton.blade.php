...
<head>
    ...
    <title>Chi tiết phiếu tồn</title>
                    ...
                    <div class="col-xs-6" align=center>
                        <div class="box box-info" style="min-height:500px">
                            <div class="box-header">
                                <form action="ctpton" method="post">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieuton->id}}" name="id_phieuton"
                                            id="id_phieuton" class="form-control" required />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" value="{{$phieuton->ThanhTien}}" name="ThanhTien"
                    ...
                    <div class="col-xs-6">
                        <div class="box box-danger" style="min-height:500px">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">{{$phieuton->ma}}{{$phieuton->id}}</h3><br>
                            </div>
                            <div class="box-body">
                                @if(session('thongbao'))
                                ...
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style=" text-align: center">
                                            ...
                                            <td><a href="/ctpton/xoactpton/{{$cthdban->id}}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="/suactpton" method="post">
                                <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="ThanhTien" class="form-control"
                                        value="{{$ct->phieuton->ThanhTien}}" />
                                </div>
                                <input type="hidden" name="id_phieuton" value="{{$ct->id_phieuton}}" />
