...
<link rel="apple-touch-icon" href="login/images/apple-touch-icon.png">
	...
	<!-- Bootstrap CSS -->
	<link rel="stylesheet" href="login/csslogin/bootstrap.min.css">
	<!-- menu thêm -->
	<link rel="stylesheet" href="login/csslogin/menu.css">
	<!-- button -->
	<link rel="stylesheet" href="login/csslogin/button.css">
	<!-- Site CSS -->
	<link rel="stylesheet" href="login/csslogin/style.css">
	<!-- Responsive CSS -->
	<link rel="stylesheet" href="login/csslogin/responsive.css">
	<!-- Custom CSS -->
	<link rel="stylesheet" href="login/csslogin/custom.css">
...
<style type="text/css">
        body{
            background-image: url(login/image/background.jpg);
