      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Thêm cơ sở</h3>
            </div>
            @if(session('thongbao'))
		...
		<div class="box-body">
			<div class="table table-bordered table-hover">
        	    <form action="themcs" method="post">
                <input type="hidden" name="_token" value="{{csrf_token()}}"/>
            	<div class="form-group">
                	<label>Mã CH</label>
                    <input type="text" name="MaCH" class="form-control" placeholder="Ma CH" required />
                </div>
                <div class="form-group">
                	<label>Tên CH</label>
                    <input type="text" name="TenCH" class="form-control" placeholder="Ten CH" required />
                </div>
                <div class="form-group">
                	<label>SDT</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="TenQL" class="form-control" placeholder="Ten quan ly" required />
                </div>
                <div class="form-group" >
				<label>Hiển thị lên web online</label><br>
                    <label class="ra">Có
                    <input type="radio" checked="checked" name="hienthi" value="1">
                ...
                <input type="submit" name="submit" value="Thêm" class="btn btn-primary">
									<a href="coso" class="btn btn-danger">Hủy bỏ</a>
								</div>
							</div>
						</form>
