        ...
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <option type="text" name="id_monan" class="form-control" value="{{$cthdban->id_monan}}">
                        {{$cthdban->monan->Ten}}</option>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <option type="text" class="form-control" value="{{$cthdban->TongTien}}">{{$cthdban->TongTien}}
                    </option>
                </div>
                <div class="form-group">
