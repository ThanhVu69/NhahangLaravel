                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Nhập hàng hóa</h3>
                            </div>
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="box-body">
                                        ...
                                        <table id="example1" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ url('themnhaphangan/'.$product->id) }}"
                                ...
                                <div class="col-xs-6">
                                    <div class="box-body">
                                                ...
                                                <tr style=" text-align: center">
                                                    ...
                                                    <td class="actions" style=" text-align: center" data-th="">
                                                        <button class="btn btn-info btn-sm update-cart"
                                                            data-id="{{ $id }}"><i class="fa fa-refresh"></i></button>
                                        ...
                                        <div class="span4 pull-right">
                                            <table id="example2" class="table table-bordered table-hover">
                                                <form action="giohangannhap" method="post">
