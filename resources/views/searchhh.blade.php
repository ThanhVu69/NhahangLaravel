...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="icon" type="image/png" href="login1/images/icons/search.png"/>
...
@include('trangquanly.thanhmenu')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="giohanghoa">Xem hàng nhập</a></li><br>
      @else
      <a href="giohanghoatrong">Xem hàng nhập</a></li><br>
      @endif
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="homiee">Hàng hóa</a></li><br>
            ...
            <div class="box-body">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                 ...
                 <tr>
			     <td>{{$item->ma}}</td>
          <td><a href="{!!url('nhaphang',[$item->id])!!}" >{{$item->Ten}}</a></td>
				 <td>{{$item->DVTinh}}</td>
			     </tr>
			      @endforeach
